...
// Whether the first-run city prompt has been asked. Asked once when there is
// no location at all; afterwards this stays true whether it was answered or
// skipped, so a fresh install asks exactly once.
function locationPrompted(settings) { return boolean(settings, "locationPrompted") }
